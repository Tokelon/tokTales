...
abstract class AndroidGL20Flags implements IGLFlags {
	...
	//private static final TIntIntHashMap GL20_FLAG_MAP = new TIntIntHashMap(100, 1f, Integer.MAX_VALUE, Integer.MIN_VALUE);
	protected static final Map<Integer, Integer> GL20_FLAG_MAP = new HashMap<>(); 
