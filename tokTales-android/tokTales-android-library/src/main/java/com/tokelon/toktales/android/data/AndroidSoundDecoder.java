...
public class AndroidSoundDecoder implements ISoundAssetDecoder {
	// TODO: Implement
	
	
	@Override
	public ISoundAsset decode(InputStream inputstream, ISoundAssetKey key) throws AssetException {
