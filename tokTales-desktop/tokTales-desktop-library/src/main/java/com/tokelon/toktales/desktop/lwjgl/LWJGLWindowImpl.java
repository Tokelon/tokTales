...
public class LWJGLWindowImpl implements IWindow {
	...
	public LWJGLWindowImpl(long id, String title) {
		this(-1, -1, title, -1, -1);
		this.windowId = id;
		this.initialized = true;
	}

	public LWJGLWindowImpl(int width, int height, String title) {
		this(width, height, title, 0L, 0L);
	}
	
	public LWJGLWindowImpl(int width, int height, String title, long monitor) {
		this(width, height, title, monitor, 0L);
	}
	
	public LWJGLWindowImpl(int width, int height, String title, long monitor, long share) {
