...
import com.tokelon.toktales.core.game.state.GenericGamesceneAssignment;
import com.tokelon.toktales.core.game.state.GenericSceneGamestateProvider;
import com.tokelon.toktales.core.game.state.IGameScene;
import com.tokelon.toktales.core.game.state.GenericSceneGamestateProvider.IGenericSceneGamestateFactory;
...
public class TestCoreStateSceneTypeConstraints {
	...
	private static class TestGamescene<T> extends BaseGamescene implements ITestGamescene<T> {
		...
		protected ILogger getLogger() {
			return LoggingManager.getLogger(getClass());
		}
	}
