...
public class SpriteAssetManager extends DefaultAssetManager<ISpriteAsset, ISpriteAssetKey, IOptions> implements ISpriteAssetManager {
	...
	public SpriteAssetManager(
			...
			ISpecialAssetManager<ISpriteAsset> specialAssetManager,
			IAssetStore<ISpriteAsset, ISpriteAssetKey> assetStore,
			IAssetLoader<ISpriteAsset, ISpriteAssetKey, IOptions> assetLoader
	) {
	...
	public ISpriteAssetKey keyOf(String spriteName, IReadableAssetKey readableKey) {
		return new ReadDelegateSpriteAssetKey(spriteName, readableKey);
	}
