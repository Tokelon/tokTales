...
public class SLF4JTokLogger implements ITokLogger {


	public static final String DEFAULT_TAG = "Log";

	private static final Logger defaultLogger = LoggerFactory.getLogger(SLF4JTokLogger.class);
	

	private final Logger logger;
	
	public SLF4JTokLogger() {
		this.logger = defaultLogger;
	}
	
	public SLF4JTokLogger(String name) {
		this.logger = LoggerFactory.getLogger(name);
	}
	
	public SLF4JTokLogger(Class<?> clazz) {
