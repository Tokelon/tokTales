...
import com.tokelon.toktales.core.game.state.DefaultGamestate;
import com.tokelon.toktales.core.game.state.GameSceneControl;
import com.tokelon.toktales.core.game.state.GameStateControl;
import com.tokelon.toktales.core.game.state.IBaseGamestateFactory;
...
import com.tokelon.toktales.core.game.state.IGameSceneControl;
...
import com.tokelon.toktales.core.game.state.GameSceneControl.GameSceneControlFactory;
import com.tokelon.toktales.core.game.state.IGameSceneControl.IGameSceneControlFactory;
	...
	protected void configure() {
		...
		bindInEngineScope(IEngineContext.class, EngineContext.class);
		 ...
		 bindInEngineScope(IEngine.class, Engine.class); // bindings in platform module
		  ...
		  bindInEngineScopeAndForNotScoped(ISurfaceManager.class, DefaultSurfaceManager.class);
