...
public class StraightGameMotion implements IGameMotion {
	...
	// TODO: Remove this class and use StraightGameMotionImpl instead
	...
	public float getHorizontalPosition(int timePassedMillis) {
		float pos;
		if(mVelocityHorizontal == 0.0f) {	// TODO: FLOAT equals
			pos = mOriginX;
		}
		else {
			pos = mOriginX + mVelocityHorizontal * timePassedMillis / 1000.0f;
		}
	...
	public float getVerticalPosition(int timePassedMillis) {
		float pos;
		if(mVelocityVertical == 0.0f) {		// TODO: FLOAT equals
			pos = mOriginY;
		}
		else {
			pos = mOriginY + mVelocityVertical * timePassedMillis / 1000.0f;
		}
