 ...
 */
public interface IGL12 extends IGL {
	/**
	...
	*/
     ...
     */
    //public void glDrawRangeElements(int mode, @NativeType("GLuint") int start, @NativeType("GLuint") int end, int count, int type, long indices);
     ...
     * @param indices a pointer to the location where the indices are stored
     */
    //public void glDrawRangeElements(int mode, @NativeType("GLuint") int start, @NativeType("GLuint") int end, int type, ByteBuffer indices);
     ...
     * @param indices a pointer to the location where the indices are stored
     */
    //public void glDrawRangeElements(int mode, @NativeType("GLuint") int start, @NativeType("GLuint") int end, ByteBuffer indices);
     ...
     * @param indices a pointer to the location where the indices are stored
     */
    //public void glDrawRangeElements(int mode, @NativeType("GLuint") int start, @NativeType("GLuint") int end, ShortBuffer indices);
     ...
     * @param indices a pointer to the location where the indices are stored
     */
    //public void glDrawRangeElements(int mode, @NativeType("GLuint") int start, @NativeType("GLuint") int end, IntBuffer indices);
