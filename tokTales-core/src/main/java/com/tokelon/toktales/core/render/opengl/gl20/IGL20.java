 ...
 */
public interface IGL20 extends IGL {
	/**
...
//        GL_MAX_TEXTURE_COORDS               = 0x8871;
	...
	*/
     ...
     */
    //public void glShaderSource(int shader, PointerBuffer strings, @Nullable IntBuffer length);
     ...
     */
    //public void glShaderSource(int shader, PointerBuffer strings, @Nullable int[] length);
